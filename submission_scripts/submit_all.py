...
# timings
exp_timings_2_epochs = {"256g256l": dict([("RUNTIME", "00:10:00"), ("NNODES", "64"), ("LBS", "256"), ("TASKS", "4"), ("GPUs", "4"), ("EPOCHS", "2")]),
...
for key in experiments:
    ...
    if "SUBSET_FACTOR" in experiments[key]:
        ...
        subset_factor = "0"
    if "BATCH_ITER" in experiments[key]:
        batch_iter = experiments[key]["BATCH_ITER"]
    else:
        batch_iter = "0"
