...
# WS
experiments = {"1g256l": dict([("RUNTIME", "01:00:00"), ("NNODES", "1"), ("LBS", "256"), ("TASKS", "1"), ("GPUs", "1"), ("SUBSET_FACTOR", "256")]),
               "2g256l": dict([("RUNTIME", "01:00:00"), ("NNODES", "1"), ("LBS", "256"), ("TASKS", "2"), ("GPUs", "2"), ("SUBSET_FACTOR", "128")]),
               "4g256l": dict([("RUNTIME", "01:00:00"), ("NNODES", "1"), ("LBS", "256"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "64")]),
               "8g256l": dict([("RUNTIME", "01:00:00"), ("NNODES", "2"), ("LBS", "256"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "32")]),
               "16g256l": dict([("RUNTIME", "01:00:00"), ("NNODES", "4"), ("LBS", "256"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "16")]),
               "32g256l": dict([("RUNTIME", "01:00:00"), ("NNODES", "2"), ("LBS", "256"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "8")]),
               "64g256l": dict([("RUNTIME", "01:00:00"), ("NNODES", "2"), ("LBS", "256"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "4")]),
               "128g256l": dict([("RUNTIME", "01:00:00"), ("NNODES", "2"), ("LBS", "256"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "2")])}

experiments = {"32g256l": dict([("RUNTIME", "01:00:00"), ("NNODES", "2"), ("LBS", "256"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "8")]),
               "64g128l": dict([("RUNTIME", "01:00:00"), ("NNODES", "2"), ("LBS", "128"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "4")]),
               "128g64l": dict([("RUNTIME", "01:00:00"), ("NNODES", "2"), ("LBS", "64"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "2")])}

experiments = {"1g256l": dict([("RUNTIME", "07:00:00"), ("NNODES", "1"), ("LBS", "256"), ("TASKS", "1"), ("GPUs", "1"), ("SUBSET_FACTOR", "16")]),
               "2g128l": dict([("RUNTIME", "07:00:00"), ("NNODES", "1"), ("LBS", "128"), ("TASKS", "2"), ("GPUs", "2"), ("SUBSET_FACTOR", "8")]),
               "4g64l": dict([("RUNTIME", "07:00:00"), ("NNODES", "1"), ("LBS", "64"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "4")]),
               "8g32l": dict([("RUNTIME", "07:00:00"), ("NNODES", "2"), ("LBS", "32"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "2")])}

experiments = {"4g256l": dict([("RUNTIME", "00:10:00"), ("NNODES", "1"), ("LBS", "256"), ("TASKS", "4"), ("GPUs", "4"), ("SUBSET_FACTOR", "64"), ("EPOCHS", "2")])}
